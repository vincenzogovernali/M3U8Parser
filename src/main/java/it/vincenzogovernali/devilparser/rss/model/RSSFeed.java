...
public final class RSSFeed implements Feed {
    public static final String XML_TAG = "channel";
    ...
    @NonNull
    public static RSSFeed read(@NonNull XmlPullParser parser, int maxItems)
                ...
                switch (tagName) {
                    ...
                    default:
                        try {
                            ...
                            log.info(TAG, "Unknown RSS feed tag " + tagName);
                ...
                if (Utils.ITUNES_NAMESPACE.equalsIgnoreCase(namespace)) {
                    ...
                    if (Utils.MEDIA_NAMESPACE.equalsIgnoreCase(namespace)) {
                        ...
                        if (Utils.CONTENT_NAMESPACE.equalsIgnoreCase(namespace)) {
                            ...
                            log.info(TAG, "Unknown RSS feed extension " + parser.getNamespace());
                            Utils.skipTag(parser);
                        }
                    }
                }
    ...
    public String getDescription() {
        return Strings.isNullOrEmpty(description) && content != null ? content.encoded : description;
    }
